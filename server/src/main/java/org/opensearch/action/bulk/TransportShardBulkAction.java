...
public class TransportShardBulkAction extends TransportWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    public static void performOnPrimary(
        ...
        new ActionRunnable<PrimaryResult<BulkShardRequest, BulkShardResponse>>(listener) {
            ...
            private final StopWatch translogStopWatch = new StopWatch("translog");
            private final StopWatch luceneStopWatch = new StopWatch("lucene");
            private final StopWatch markSeqNoStopWatch = new StopWatch("markSeqNo");
            private final StopWatch shardBulkStopWatch = new StopWatch("shardBulk");


            @Override
            protected void doRun() throws Exception {
                shardBulkStopWatch.start();
                ...
                shardBulkStopWatch.stop();
                logger.info("Time to execute {} {} {} {}",
                    shardBulkStopWatch.shortSummary(), luceneStopWatch.shortSummary(), translogStopWatch.shortSummary(), markSeqNoStopWatch.shortSummary());
    ...
    static boolean executeBulkItemRequest(
        ...
        StopWatch translogStopWatch,
        StopWatch luceneStopWatch,
        StopWatch markSeqNoStopWatch
    ) throws Exception {
